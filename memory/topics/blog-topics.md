...
- **secondary_queries:** автоматизация финотдела, статусы эдо google sheets, 2026
- **search_intent:** workflow
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-05 · trend-scored · tags:sheets,автоматизация
- **h2_outline:**
  1. Когда это нужно финотделу (и когда нет)
  2. Подготовка данных и безопасность (без сырых ПДн в облако)
  3. Пошаговая настройка / скрипт / сценарий
...
## B47 — Очередь согласования оплат в Telegram
...
- **secondary_queries:** автоматизация финотдела, согласование оплат telegram sla, 2026
- **search_intent:** workflow
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-05 · trend-scored · tags:telegram,n8n
- **h2_outline:**
  1. Когда это нужно финотделу (и когда нет)
  2. Подготовка данных и безопасность (без сырых ПДн в облако)
  3. Пошаговая настройка / скрипт / сценарий
...
## B48 — Разнести комиссию банка в ДДС
...
- **secondary_queries:** автоматизация финотдела, разнести комиссию банка ддс, 2026
- **search_intent:** how_to
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-05 · trend-scored · tags:правила
- **h2_outline:**
  1. Когда это нужно финотделу (и когда нет)
  2. Подготовка данных и безопасность (без сырых ПДн в облако)
  3. Пошаговая настройка / скрипт / сценарий
...
## B49 — Подотчёт: авансы и чеки в одном реестре
...
- **secondary_queries:** автоматизация финотдела, учет подотчетных google sheets, 2026
- **search_intent:** workflow
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-05 · trend-scored · tags:sheets
- **h2_outline:**
  1. Когда это нужно финотделу (и когда нет)
  2. Подготовка данных и безопасность (без сырых ПДн в облако)
  3. Пошаговая настройка / скрипт / сценарий
...
## B50 — Зарплатная ведомость → файл в банк
...
- **secondary_queries:** автоматизация финотдела, зарплатная ведомость файл для банка, 2026
- **search_intent:** how_to
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-05 · trend-scored · tags:excel
- **h2_outline:**
  1. Когда это нужно финотделу (и когда нет)
  2. Подготовка данных и безопасность (без сырых ПДн в облако)
  3. Пошаговая настройка / скрипт / сценарий
...
- **secondary_queries:** автоматизация финотдела, abc анализ дебиторской задолженности, 2026
- **search_intent:** how_to
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-07 · trend-scored · tags:excel
- **h2_outline:**
  1. Когда это нужно финотделу (и когда нет)
  2. Подготовка данных и безопасность (без сырых ПДн в облако)
  3. Пошаговая настройка / скрипт / сценарий
...
## B85 — Скоркард поставщиков в Sheets
...
- **secondary_queries:** автоматизация финотдела, оценка поставщиков google sheets, 2026
- **search_intent:** workflow
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-19 · trend-scored · bank+tags:sheets
...
## B86 — Списания ТМЦ глазами финансиста
...
- **secondary_queries:** автоматизация финотдела, списание тмц управленческий учет sheets, 2026
- **search_intent:** how_to
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-19 · trend-scored · bank+tags:sheets
...
## B87 — Учёт авансов выданных поставщикам
...
- **secondary_queries:** автоматизация финотдела, учет авансов поставщикам google sheets, 2026
- **search_intent:** workflow
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-19 · trend-scored · bank+tags:sheets
...
## B88 — Реестр возвратов покупателям
...
- **secondary_queries:** автоматизация финотдела, реестр возвратов покупателям excel, 2026
- **search_intent:** workflow
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-19 · trend-scored · bank+tags:sheets
...
## B89 — Прогноз поступлений на 30 дней
...
- **secondary_queries:** автоматизация финотдела, прогноз поступлений google sheets, 2026
- **search_intent:** how_to
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-19 · trend-scored · bank+tags:sheets
...
## B90 — Cursor Skill под выгрузки 1С
...
- **secondary_queries:** автоматизация финотдела, cursor skill 1с odata, 2026
- **search_intent:** checklist
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-22 · trend-scored · bank+tags:cursor,skill,вайбкодинг,1с,odata
- **h2_outline:**
  1. Когда это нужно финотделу (и когда нет)
  2. Подготовка данных и безопасность (без сырых ПДн в облако)
  3. Пошаговая настройка / скрипт / сценарий
...
- **secondary_queries:** автоматизация финотдела, http сервис 1с создать счет json, 2026
- **search_intent:** how_to
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-22 · trend-scored · bank+tags:http,веб-сервис,1с,api,приложение
- **h2_outline:**
  1. Когда это нужно финотделу (и когда нет)
  2. Подготовка данных и безопасность (без сырых ПДн в облако)
  3. Пошаговая настройка / скрипт / сценарий
...
## B92 — MCP Google Sheets в Cursor
...
- **secondary_queries:** автоматизация финотдела, mcp google sheets cursor, 2026
- **search_intent:** how_to
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-22 · trend-scored · bank+tags:mcp,sheets,cursor,api,интеграция
- **h2_outline:**
  1. Когда это нужно финотделу (и когда нет)
  2. Подготовка данных и безопасность (без сырых ПДн в облако)
  3. Пошаговая настройка / скрипт / сценарий
...
## B93 — Ротация ключа service account
...
- **secondary_queries:** автоматизация финотдела, ротация ключа service account google sheets, 2026
- **search_intent:** how_to
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-22 · trend-scored · bank+tags:sheets,api,security,интеграция
- **h2_outline:**
  1. Когда это нужно финотделу (и когда нет)
  2. Подготовка данных и безопасность (без сырых ПДн в облако)
  3. Пошаговая настройка / скрипт / сценарий
...
## B94 — Прокси OData 1С на FastAPI
...
- **secondary_queries:** автоматизация финотдела, fastapi odata 1с прокси, 2026
- **search_intent:** how_to
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-22 · trend-scored · bank+tags:odata,api,веб-сервис,1с
- **h2_outline:**
  1. Когда это нужно финотделу (и когда нет)
  2. Подготовка данных и безопасность (без сырых ПДн в облако)
  3. Пошаговая настройка / скрипт / сценарий
...
- **secondary_queries:** автоматизация финотдела, http сервис 1с telegram дебиторка, 2026
- **search_intent:** workflow
- **article_mode:** B
- **author_id:** olga-kondratskaya
- **source_notes:** scout_ci 2026-08-22 · trend-scored · bank+tags:http,веб-сервис,1с,api
- **h2_outline:**
  1. Когда это нужно финотделу (и когда нет)
  2. Подготовка данных и безопасность (без сырых ПДн в облако)
  3. Пошаговая настройка / скрипт / сценарий
