...
## 2026-09-04 — B92 mcp-google-sheets-cursor-reestry — **❌ PUBLISH BLOCKER**
...
- link-verify.json: pass (12/12, site-base https://koda-fd.ru)
...
Ledger `shared/published-articles.md` **не** обновлялся (нет live permalink).
