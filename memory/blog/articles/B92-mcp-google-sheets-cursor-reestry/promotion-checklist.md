...
Дата публикации: unpublished (PUBLISH BLOCKER 2026-09-23)  
Live URL: unpublished
...
Publish 2026-09-23: ❌ PUBLISH BLOCKER — нет `memory/site.env.local` / Cloud Secrets (ALLOW + PUBLIC_SITE_URL + FTP_*|SSH_*). link-verify 9/9 pass; dry-run OK (PHP 4014767). Live URL = unpublished. `published-articles.md` не обновлялся.
