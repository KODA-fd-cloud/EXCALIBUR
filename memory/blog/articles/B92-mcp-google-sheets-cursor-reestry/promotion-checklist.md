...
Дата публикации: 2026-09-04 (❌ PUBLISH BLOCKER — нет credentials)  
Live URL: (нет — publish blocked; expected https://koda-fd.ru/blog/mcp-google-sheets-cursor-reestry/ after secrets)
